...
public class SectionController {
	...
	public ResponseEntity<List<FileInfo>> getSections(@PathVariable("catalog") int catalog) {
	...
	public ResponseEntity<Boolean> save(@PathVariable("catalog") int catalog, @RequestParam EditorPageData data) {
